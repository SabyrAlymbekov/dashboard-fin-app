...
import avatar from '../data/iam.jpeg';

const UserProfile = () => {
  const { currentColor } = useStateContext();

  return (
    <div className="nav-item absolute right-1 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-100 hover:drop-shadow-2xl shadow-2xl">
      ...
      <div className="flex gap-5 items-center mt-6 border-color border-b-1 pb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 font-semibold dark:text-gray-400">
            aleksandrenkovladimir@gmail.com
          </p>
        </div>
      </div>
